...
MatrixDouble hexagonalLattice2(int n, int n1) {
	...
	coord[1].resize(2);
	coord[1][0] = sqrt(3); coord[1][1] = 0; 
	
	coord[2].resize(2);
	coord[2][0] = -sqrt(3)/2.; coord[2][1] = 0.5; 
	coord[3].resize(2);
	coord[3][0] = sqrt(3)/2.; coord[3][1] = 0.5; 
	coord[4].resize(2);
	coord[4][0] = 3*sqrt(3)/2.; coord[4][1] = 0.5; 
	
	coord[5].resize(2);
	coord[5][0] = -sqrt(3)/2.; coord[5][1] = 1.5; 
	coord[6].resize(2);
	coord[6][0] = sqrt(3)/2.; coord[6][1] = 1.5; 
	coord[7].resize(2);
	coord[7][0] = 3*sqrt(3)/2.; coord[7][1] = 1.5; 

	coord[8].resize(2);
	coord[8][0] = -sqrt(3); coord[8][1] = 2; 	
	coord[9].resize(2);
	coord[9][0] = 0; coord[9][1] = 2; 
	coord[10].resize(2);
	coord[10][0] = sqrt(3); coord[10][1] = 2; 
	coord[11].resize(2);
	coord[11][0] = 2*sqrt(3); coord[11][1] = 2;
	
	coord[12].resize(2);
	coord[12][0] = -sqrt(3); coord[12][1] = 3; 	
	coord[13].resize(2);
	coord[13][0] = 0; coord[13][1] = 3; 
	coord[14].resize(2);
	coord[14][0] = sqrt(3); coord[14][1] = 3; 
	coord[15].resize(2);
	coord[15][0] = 2*sqrt(3); coord[15][1] = 3;

	coord[16].resize(2);
	coord[16][0] = -sqrt(3)/2.; coord[16][1] = 3.5; 
	coord[17].resize(2);
	coord[17][0] = sqrt(3)/2.; coord[17][1] = 3.5; 
	coord[18].resize(2);
	coord[18][0] = 3*sqrt(3)/2.; coord[18][1] = 3.5; 
	
	coord[19].resize(2);
	coord[19][0] = -sqrt(3)/2.; coord[19][1] = 4.5; 
	coord[20].resize(2);
	coord[20][0] = sqrt(3)/2.; coord[20][1] = 4.5; 
	coord[21].resize(2);
	coord[21][0] = 3*sqrt(3)/2.; coord[21][1] = 4.5; 
	
	coord[22].resize(2);
	coord[22][0] = 0; coord[22][1] = 5; 
	coord[23].resize(2);
	coord[23][0] = sqrt(3); coord[23][1] = 5;
...
MatrixDouble squareLattice2(int n) {
	...
	coord[6].resize(2);
	coord[6][0] = 1; coord[6][1] = 1; 
	coord[7].resize(2);
	coord[7][0] = 2; coord[7][1] = 1; 
	coord[8].resize(2);
	coord[8][0] = 3; coord[8][1] = 1; 
	coord[9].resize(2);
	coord[9][0] = 4; coord[9][1] = 1; 
	
	coord[10].resize(2);
	coord[10][0] = 0; coord[10][1] = 2; 
	coord[11].resize(2);
	coord[11][0] = 1; coord[11][1] = 2; 
	coord[12].resize(2);
	coord[12][0] = 2; coord[12][1] = 2; 
	coord[13].resize(2);
	coord[13][0] = 3; coord[13][1] = 2; 
	coord[14].resize(2);
	coord[14][0] = 4; coord[14][1] = 2; 
	
	coord[15].resize(2);
	coord[15][0] = 0; coord[15][1] = 3; 
	coord[16].resize(2);
	coord[16][0] = 1; coord[16][1] = 3; 
	coord[17].resize(2);
	coord[17][0] = 2; coord[17][1] = 3; 
	coord[18].resize(2);
	coord[18][0] = 3; coord[18][1] = 3; 
	coord[19].resize(2);
	coord[19][0] = 4; coord[19][1] = 3; 
	
	coord[20].resize(2);
	coord[20][0] = 0; coord[20][1] = 4; 
	coord[21].resize(2);
	coord[21][0] = 1; coord[21][1] = 4; 
	coord[22].resize(2);
	coord[22][0] = 2; coord[22][1] = 4; 
	coord[23].resize(2);
	coord[23][0] = 3; coord[23][1] = 4; 
	coord[24].resize(2);
	coord[24][0] = 4; coord[24][1] = 4; 
