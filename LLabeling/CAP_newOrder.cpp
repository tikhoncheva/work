...
MatrixDouble triangularLattice2(int n, int n1) {
	...
	coord[0][0] = 0; coord[0][1] = 0; 
	coord[5].resize(2);
	coord[5][0] = 1; coord[5][1] = 0; 
	coord[10].resize(2);
	coord[10][0] = 2; coord[10][1] = 0; 
	coord[15].resize(2);
	coord[15][0] = 3; coord[15][1] = 0; 
	coord[20].resize(2);
	coord[20][0] = 4; coord[20][1] = 0; 

	coord[12].resize(2);
	coord[12][0] = 0.5; coord[12][1] = sqrt(3)/2.; 
	coord[17].resize(2);
	coord[17][0] = 1.5; coord[17][1] = sqrt(3)/2.; 
	coord[2].resize(2);
	coord[2][0] = 2.5; coord[2][1] = sqrt(3)/2.; 
	coord[7].resize(2);
	coord[7][0] = 3.5; coord[7][1] = sqrt(3)/2.; 
	
	coord[4].resize(2);
	coord[4][0] = 0; coord[4][1] = sqrt(3); 
	coord[9].resize(2);
	coord[9][0] = 1; coord[9][1] = sqrt(3); 
	coord[14].resize(2);
	coord[14][0] = 2; coord[14][1] = sqrt(3); 
	coord[19].resize(2);
	coord[19][0] = 3; coord[19][1] = sqrt(3); 
	coord[22].resize(2);
	coord[22][0] = 4; coord[22][1] = sqrt(3); 
	
	coord[16].resize(2);
	coord[16][0] = 0.5; coord[16][1] = 3*sqrt(3)/2.; 
	coord[1].resize(2);
	coord[1][0] = 1.5; coord[1][1] = 3*sqrt(3)/2.; 
	coord[6].resize(2);
	coord[6][0] = 2.5; coord[6][1] = 3*sqrt(3)/2.; 
	coord[11].resize(2);
	coord[11][0] = 3.5; coord[11][1] = 3*sqrt(3)/2.; 
	
	coord[8].resize(2);
	coord[8][0] = 0; coord[8][1] = 2*sqrt(3); 
	coord[13].resize(2);
	coord[13][0] = 1; coord[13][1] = 2*sqrt(3); 
	coord[18].resize(2);
	coord[18][0] = 2; coord[18][1] = 2*sqrt(3); 
	coord[21].resize(2);
	coord[21][0] = 3; coord[21][1] = 2*sqrt(3); 
	coord[3].resize(2);
	coord[3][0] = 4; coord[3][1] = 2*sqrt(3); 
	return coord;
}
