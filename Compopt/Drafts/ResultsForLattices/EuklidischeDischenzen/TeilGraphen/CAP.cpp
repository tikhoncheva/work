...
int CProblem::setProblem()
{
	...
	case 1:
		/*	Trapez
		 ...
		 coordinates.resize(n);
		 coordinates[0].resize(2);
		 coordinates[0][0] = 0;
		 coordinates[0][1] = 0;
		 coordinates[1].resize(2);
		 coordinates[1][0] =	0.5;
		 coordinates[1][1] = sqrt(3)/2.;

		 coordinates[2].resize(2);
		 coordinates[2][0] = 1.5;
		 coordinates[2][1] = sqrt(3) / 2.;
		 coordinates[3].resize(2);
		 coordinates[3][0] = 2;
		 coordinates[3][1] = 0;

		 diameter = 2;
		 fileName = "function hexagonalLattice ";
		 */
	...
	case 2:
		n = 3;
		Info.numVar = 1 + n; // lambda + all c;
		coordinates = triangularLattice(n, 2); // number of vertices, number of vertices in first line
		diameter = 1;
		fileName = "function  triangularLattice.dat";
		break;
	...
	case 3:
		...
		//coordinates = squareLattice3(n, 3);	// for unsymmetric lattices
		fileName = "function squareLattice.dat";
		break;
