...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        twSchedule_hh_itime = new QTableWidget(tab);
        ...
        pbSaveReport = new QPushButton(tab);
    ...
    {
        MainWindow->setWindowTitle(QApplication::translate("MainWindow", "Report", 0));
        pbSaveReport->setText(QApplication::translate("MainWindow", "Save", 0));
        tabWidget->setTabText(tabWidget->indexOf(tab), QApplication::translate("MainWindow", "Interview times", 0));
