...
//    nLongInterviews = constant::nLongInterviews;                        // correct number of long interviews
    assert(planLongITimes[0].size() == constant::nLongInterviews);
    assert(planLongITimes[1].size() == constant::nLongInterviews);
    assert(planLongITimes[2].size() == constant::nLongInterviews);
    ...
    std::vector<unsigned int> weeks(constant::nLongInterviews);
    ...
    for (unsigned int i=0; i< constant::nLongInterviews; ++i)
    {
    ...
    */
    ...
    unsigned int nShortI_inOneWeek = constant::nShortInterviews / constant::nweeks;
    unsigned int R = constant::nShortInterviews % constant::nweeks; // remainder
 ...
 * -------------------------------------------------------------------------------------------------
 */
int initialsolution1(std::vector<stVillage> _villages,           // villages
                      std::vector<stHousehold> _households,         // _households
                      ...
                      )
{
    ...
    _hhITimePlan_weekly = assign_hh_to_weeks(_households_sorted);
    std::cout << " ... finished\n" << std::endl;
