...
void plot_roads(QCustomPlot*, std::vector<stVillage>,
                std::vector<stRoad>,
                std::vector<std::vector<adjmatrix_entry> >);

void plot_route_week(QCustomPlot*, const std::vector<stVillage>,
                     stInterviewer, unsigned int,
                     const std::vector<std::vector<unsigned int> >);

void plot_route_day(QCustomPlot*, const std::vector<stVillage>,
                    stInterviewer, unsigned int,
                    const std::vector<std::vector<unsigned int> >);
