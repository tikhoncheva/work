...
/*
 * ------------------------------------------------------------------------------------
 * Table (2D-vector), those rows correspond to the ID of the villages and columns to the ID of
                         ...
                         std::vector<stHousehold> _households)
{
    ...
    constant::maxTimeDistDry = 0.;
    constant::maxTimeDistRain = 0.;
    ...
    for (unsigned int i=0; i< V; ++i)
    {
        ...
        if (maxDry > constant::maxTimeDistDry)
            constant::maxTimeDistDry = maxDry;
        if (maxRain > constant::maxTimeDistRain)
            constant::maxTimeDistRain = maxRain;
    }
...
//    std::cout << std::endl;
    ...
    double workTimeYear = nK * 240 /*days*/
                             * 8  /*hours*/
                             * 60 /*min*/;
    ...
    constant::summaryLongITime = sLongITime1;
    constant::nLongInterviews = nLongHh;
    constant::nShortInterviews = nShortHh;
    ...
    std::cout << "      Working time " << workTimeYear << std::endl;
    ...
    std::cout << "      -----------------------------------------" << std::endl;
    std::cout << "      Remains for travel time " << workTimeYear - 3 * sShortITime
