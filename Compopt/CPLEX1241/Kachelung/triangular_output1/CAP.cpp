...
int CProblem::setModel() {
	...
	try {
		...
		if (max_distance == 2) 
		{
		  ...
		  // Dreiecke mit Seitenlaenge 2
		  model.add(c[0]+c[2]+c[10] >= 3);
		  model.add(c[2]+c[10]+c[12] >= 3);
		  model.add(c[2]+c[4]+c[12] >= 3);
		  model.add(c[9]+c[11]+c[19] >= 3);
		  model.add(c[11]+c[19]+c[21] >= 3);
		  model.add(c[11]+c[13]+c[21] >= 3);
		  
		  // Dreiecke mit Seitenlaenge 3
		  model.add(c[0]+c[3]+c[15] >= 0);
		  model.add(c[7]+c[19]+c[22] >= 0);
		  //
		}
		...
		if (max_distance == 3) 
		{
		  ...
		  // Dreiecke mit Seitenlaenge 2
		  model.add(c[0]+c[2]+c[10] >= 6);
		  model.add(c[2]+c[10]+c[12] >= 6);
		  model.add(c[2]+c[4]+c[12] >= 6);
		  model.add(c[9]+c[11]+c[19] >= 6);
		  model.add(c[11]+c[19]+c[21] >= 6);
		  model.add(c[11]+c[13]+c[21] >= 6);
		  
		  // Dreiecke mit Seitenlaenge 3
		  model.add(c[0]+c[3]+c[15] >= 3);
		  model.add(c[7]+c[19]+c[22] >= 3);
