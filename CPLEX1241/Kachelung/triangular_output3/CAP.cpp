...
int CProblem::setModel() {
	...
	try {
		...
		if (max_distance == 2) 
		{
		  ...
		  model.add(c[1]+c[2]+c[5]+c[7]+c[10]+c[11] >=16.6077);
		  model.add(c[2]+c[3]+c[6]+c[8]+c[11]+c[12] >=16.6077);
		  
		  model.add(c[5]+c[6]+c[9]+c[11]+c[14]+c[15] >=16.6077);
		  model.add(c[6]+c[7]+c[10]+c[12]+c[15]+c[16] >=16.6077);
		  model.add(c[7]+c[8]+c[11]+c[13]+c[16]+c[17] >=16.6077);
		  
		  model.add(c[10]+c[11]+c[14]+c[16]+c[19]+c[20] >=16.6077);
		  model.add(c[11]+c[12]+c[15]+c[17]+c[20]+c[21] >=16.6077);
		  //
		}
		...
		{
		  // Sechsecke mit der Seitenlaenge 1
		  model.add(c[1]+c[2]+c[5]+c[7]+c[10]+c[11] >=31.6077);
		  model.add(c[2]+c[3]+c[6]+c[8]+c[11]+c[12] >=31.6077);
		  
		  model.add(c[5]+c[6]+c[9]+c[11]+c[14]+c[15] >=31.6077);
		  model.add(c[6]+c[7]+c[10]+c[12]+c[15]+c[16] >=31.6077);
		  model.add(c[7]+c[8]+c[11]+c[13]+c[16]+c[17] >=31.6077);
		  
		  model.add(c[10]+c[11]+c[14]+c[16]+c[19]+c[20] >=31.6077);
		  model.add(c[11]+c[12]+c[15]+c[17]+c[20]+c[21] >=31.6077);
		  //
		}
